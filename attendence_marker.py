...
from database import Punch, Session, add_punch
...
class Marker:
    ...
    def start_session(self):
        ...
        try:
            ...
            present_list = []
            with Session() as s:
                present_list = s.query(Punch).all()
                ...
                if ret:
                    ...
                    for (x,y,w,h) in faces_rect:
                        ...
                        for student in present_list:
                            if student.student_name == self.student_list[label]:
                                print(f"Duplicate entry: {self.student_list[label]}")
                                break
                        else:
                            print(f"Present: {self.student_list[label]}")
                            p = Punch()
                            p.student_name = self.student_list[label]
                            present_list.append(p)
                            add_punch(self.student_list[label])
